...
public class FileSystemAsciiDocComponentsDetailsViewOutput<T>: IViewsOutput<T>
{
    ...
    public FileSystemAsciiDocComponentsDetailsViewOutput(string absoluteDirectoryPath)
    {
        ...
        _relativePaths.Add(AsciiDocBackendDetailsViewDefinition.Id, "BackendDetails_full.adoc");
        _relativePaths.Add(AsciiDocFrontendDetailsViewDefinition.Id, "FrontendDetails_full.adoc");
    }
